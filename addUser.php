            ...
            <div class="col-10">
                ...
                <form action="insUser.php" method="post" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="tusername" id="username" placeholder="Username">
                    </div>
                    <div class="mb-3">
                        <label for="13" class="form-label">Password</label>
                        <input type="password" class="form-control" name="tpassword" id="password" placeholder="password" required>
                    </div>
                    <div class="mb-3">
