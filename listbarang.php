...
<body>
    <nav class="nav nav-pills flex-sm-row bg-primary">
        ...
        <span class="nav-link text-warning disabled" aria-current="page">List Barang</span>
        <a class="flex-sm-fill text-sm-end nav-link text-light" href="listUser.php">List User</a>
